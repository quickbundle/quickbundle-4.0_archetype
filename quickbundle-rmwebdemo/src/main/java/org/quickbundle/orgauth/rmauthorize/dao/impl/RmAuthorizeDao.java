//代码生成时,文件路径: e:/download/QbRmWebDemo/src/main/java/orgauth/rmauthorize/dao/impl/RmAuthorizeDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmauthorize.dao.impl --> RmAuthorizeDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmauthorize.dao.impl;
...
public class RmAuthorizeDao extends RmJdbcTemplate implements IRmAuthorizeDao, IRmAuthorizeConstants {
    ...
    public String insert(RmAuthorizeVo vo) {
        ...
        vo.setId(id);
        Object[] obj = { vo.getId(), vo.getName(),vo.getBs_keyword(),vo.getIs_alone_table(),vo.getAuthorize_resource_table_name(),vo.getAuthorize_resrec_table_name(),vo.getAuthorize_affix_table_name(),vo.getSettiing_option(),vo.getCustom_code(),vo.getDescription(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmAuthorizeVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmAuthorizeVo vo = (RmAuthorizeVo)obj;
				return new Object[]{ vo.getId(), vo.getName(),vo.getBs_keyword(),vo.getIs_alone_table(),vo.getAuthorize_resource_table_name(),vo.getAuthorize_resrec_table_name(),vo.getAuthorize_affix_table_name(),vo.getSettiing_option(),vo.getCustom_code(),vo.getDescription(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmAuthorizeVo find(String id) {
        return (RmAuthorizeVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmAuthorizeVo vo) {
        Object[] obj = { vo.getName(),vo.getBs_keyword(),vo.getIs_alone_table(),vo.getAuthorize_resource_table_name(),vo.getAuthorize_resrec_table_name(),vo.getAuthorize_affix_table_name(),vo.getSettiing_option(),vo.getCustom_code(),vo.getDescription(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmAuthorizeVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmAuthorizeVo vo = (RmAuthorizeVo)obj;
				return new Object[]{ vo.getName(),vo.getBs_keyword(),vo.getIs_alone_table(),vo.getAuthorize_resource_table_name(),vo.getAuthorize_resrec_table_name(),vo.getAuthorize_affix_table_name(),vo.getSettiing_option(),vo.getCustom_code(),vo.getDescription(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
