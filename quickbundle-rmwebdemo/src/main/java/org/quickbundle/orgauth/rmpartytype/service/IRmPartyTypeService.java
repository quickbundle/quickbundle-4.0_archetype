//代码生成时,文件路径: E:/QbRmWebDemo/src/main/java/orgauth/rmpartytype/service/IRmPartyTypeService.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmpartytype.service --> IRmPartyTypeService.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmpartytype.service;
...
public interface IRmPartyTypeService {
