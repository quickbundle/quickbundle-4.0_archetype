//代码生成时,文件路径: E:/QbRmWebDemo/src/main/java/orgauth/rmpartytype/dao/impl/RmPartyTypeDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmpartytype.dao.impl --> RmPartyTypeDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmpartytype.dao.impl;
...
public class RmPartyTypeDao extends RmJdbcTemplate implements IRmPartyTypeDao, IRmPartyTypeConstants {
    ...
    public String insert(RmPartyTypeVo vo) {
        ...
        vo.setId(id);
        Object[] obj = { vo.getId(), vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmPartyTypeVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmPartyTypeVo vo = (RmPartyTypeVo)obj;
				return new Object[]{ vo.getId(), vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmPartyTypeVo find(String id) {
        return (RmPartyTypeVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmPartyTypeVo vo) {
        Object[] obj = { vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
	...
	public int[] update(final RmPartyTypeVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmPartyTypeVo vo = (RmPartyTypeVo)obj;
				return new Object[]{ vo.getBs_keyword(),vo.getName(),vo.getIcon(),vo.getDescription(),vo.getIs_custom_attribute(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
