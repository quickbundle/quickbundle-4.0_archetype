//代码生成时,文件路径: E:/QbRmWebDemo/src/main/java/orgauth/rmparty/dao/impl/RmPartyDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmparty.dao.impl --> RmPartyDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmparty.dao.impl;
...
public class RmPartyDao extends RmJdbcTemplate implements IRmPartyDao, IRmPartyConstants {

    private void initDefaultValue(RmPartyVo vo) {
        //对Party原始ID和编码的默认处理
        if(vo.getOld_party_id() == null || vo.getOld_party_id().trim().length() == 0) {
        	vo.setOld_party_id(vo.getId());
        }
    }
    ...
    public String insert(RmPartyVo vo) {
        ...
        vo.setId(id);
        initDefaultValue(vo);
        Object[] obj = { vo.getId(), vo.getParty_type_id(),vo.getOld_party_id(),vo.getName(),vo.getIs_inherit(),vo.getEmail(),vo.getDescription(),vo.getCustom1(),vo.getCustom2(),vo.getCustom3(),vo.getCustom4(),vo.getCustom5(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmPartyVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmPartyVo vo = (RmPartyVo)obj;
				return new Object[]{ vo.getId(), vo.getParty_type_id(),vo.getOld_party_id(),vo.getName(),vo.getIs_inherit(),vo.getEmail(),vo.getDescription(),vo.getCustom1(),vo.getCustom2(),vo.getCustom3(),vo.getCustom4(),vo.getCustom5(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmPartyVo find(String id) {
        return (RmPartyVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmPartyVo vo) {
        Object[] obj = { vo.getParty_type_id(),vo.getOld_party_id(),vo.getName(),vo.getIs_inherit(),vo.getEmail(),vo.getDescription(),vo.getCustom1(),vo.getCustom2(),vo.getCustom3(),vo.getCustom4(),vo.getCustom5(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmPartyVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmPartyVo vo = (RmPartyVo)obj;
				return new Object[]{ vo.getParty_type_id(),vo.getOld_party_id(),vo.getName(),vo.getIs_inherit(),vo.getEmail(),vo.getDescription(),vo.getCustom1(),vo.getCustom2(),vo.getCustom3(),vo.getCustom4(),vo.getCustom5(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
