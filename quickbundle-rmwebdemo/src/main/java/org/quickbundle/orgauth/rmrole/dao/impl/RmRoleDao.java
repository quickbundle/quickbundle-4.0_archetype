//代码生成时,文件路径: e:/download/QbRmWebDemo/src/main/java/orgauth/rmrole/dao/impl/RmRoleDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmrole.dao.impl --> RmRoleDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmrole.dao.impl;
...
public class RmRoleDao extends RmJdbcTemplate implements IRmRoleDao, IRmRoleConstants {
    ...
    public String insert(RmRoleVo vo) {
        ...
        Object[] obj = { vo.getId(), vo.getRole_code(),vo.getName(),vo.getEnable_status(),vo.getIs_system_level(),vo.getOwner_org_id(),vo.getIs_recursive(),vo.getMatrix_code(),vo.getDescription(),vo.getFunction_permission(),vo.getData_permission(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmRoleVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmRoleVo vo = (RmRoleVo)obj;
				return new Object[]{ vo.getId(), vo.getRole_code(),vo.getName(),vo.getEnable_status(),vo.getIs_system_level(),vo.getOwner_org_id(),vo.getIs_recursive(),vo.getMatrix_code(),vo.getDescription(),vo.getFunction_permission(),vo.getData_permission(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmRoleVo find(String id) {
        return (RmRoleVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmRoleVo vo) {
        Object[] obj = { vo.getRole_code(),vo.getName(),vo.getEnable_status(),vo.getIs_system_level(),vo.getOwner_org_id(),vo.getIs_recursive(),vo.getMatrix_code(),vo.getDescription(),vo.getFunction_permission(),vo.getData_permission(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmRoleVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmRoleVo vo = (RmRoleVo)obj;
				return new Object[]{ vo.getRole_code(),vo.getName(),vo.getEnable_status(),vo.getIs_system_level(),vo.getOwner_org_id(),vo.getIs_recursive(),vo.getMatrix_code(),vo.getDescription(),vo.getFunction_permission(),vo.getData_permission(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
