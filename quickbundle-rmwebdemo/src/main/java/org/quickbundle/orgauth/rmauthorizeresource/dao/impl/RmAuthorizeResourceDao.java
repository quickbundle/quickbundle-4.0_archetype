//代码生成时,文件路径: e:/download/QbRmWebDemo/src/main/java/orgauth/rmauthorizeresource/dao/impl/RmAuthorizeResourceDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmauthorizeresource.dao.impl --> RmAuthorizeResourceDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmauthorizeresource.dao.impl;
...
public class RmAuthorizeResourceDao extends RmJdbcTemplate implements IRmAuthorizeResourceDao, IRmAuthorizeResourceConstants {
    ...
    public String insert(RmAuthorizeResourceVo vo) {
        ...
        vo.setId(id);
        Object[] obj = { vo.getId(), vo.getAuthorize_id(),vo.getOld_resource_id(),vo.getDefault_access(),vo.getDefault_is_affix_data(),vo.getDefault_is_recursive(),vo.getDefault_access_type(),vo.getTotal_code(),vo.getName(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmAuthorizeResourceVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmAuthorizeResourceVo vo = (RmAuthorizeResourceVo)obj;
				return new Object[]{ vo.getId(), vo.getAuthorize_id(),vo.getOld_resource_id(),vo.getDefault_access(),vo.getDefault_is_affix_data(),vo.getDefault_is_recursive(),vo.getDefault_access_type(),vo.getTotal_code(),vo.getName(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmAuthorizeResourceVo find(String id) {
        return (RmAuthorizeResourceVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmAuthorizeResourceVo vo) {
        Object[] obj = { vo.getAuthorize_id(),vo.getOld_resource_id(),vo.getDefault_access(),vo.getDefault_is_affix_data(),vo.getDefault_is_recursive(),vo.getDefault_access_type(),vo.getTotal_code(),vo.getName(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmAuthorizeResourceVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmAuthorizeResourceVo vo = (RmAuthorizeResourceVo)obj;
				return new Object[]{ vo.getAuthorize_id(),vo.getOld_resource_id(),vo.getDefault_access(),vo.getDefault_is_affix_data(),vo.getDefault_is_recursive(),vo.getDefault_access_type(),vo.getTotal_code(),vo.getName(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
