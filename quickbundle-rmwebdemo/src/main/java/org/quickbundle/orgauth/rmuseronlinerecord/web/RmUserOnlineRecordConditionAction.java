//代码生成时,文件路径: e:/download/QbRmWebDemo/src/main/java/orgauth/rmuseronlinerecord/web/RmUserOnlineRecordConditionAction.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmuseronlinerecord.web --> RmUserOnlineRecordConditionAction.java
 * 
 * 功能描述:
 * 
...
public class RmUserOnlineRecordConditionAction extends RmUserOnlineRecordAction implements IRmUserOnlineRecordConstants {
