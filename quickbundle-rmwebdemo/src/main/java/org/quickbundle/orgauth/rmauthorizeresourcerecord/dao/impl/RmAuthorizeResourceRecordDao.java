//代码生成时,文件路径: e:/download/QbRmWebDemo/src/main/java/orgauth/rmauthorizeresourcerecord/dao/impl/RmAuthorizeResourceRecordDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmauthorizeresourcerecord.dao.impl --> RmAuthorizeResourceRecordDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmauthorizeresourcerecord.dao.impl;
...
public class RmAuthorizeResourceRecordDao extends RmJdbcTemplate implements IRmAuthorizeResourceRecordDao, IRmAuthorizeResourceRecordConstants {
    ...
    public String insert(RmAuthorizeResourceRecordVo vo) {
        ...
        vo.setId(id);
        Object[] obj = { vo.getId(), vo.getAuthorize_resource_id(),vo.getParty_id(),vo.getAuthorize_status(),vo.getIs_affix_data(),vo.getIs_recursive(),vo.getAccess_type(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmAuthorizeResourceRecordVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmAuthorizeResourceRecordVo vo = (RmAuthorizeResourceRecordVo)obj;
				return new Object[]{ vo.getId(), vo.getAuthorize_resource_id(),vo.getParty_id(),vo.getAuthorize_status(),vo.getIs_affix_data(),vo.getIs_recursive(),vo.getAccess_type(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmAuthorizeResourceRecordVo find(String id) {
        return (RmAuthorizeResourceRecordVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmAuthorizeResourceRecordVo vo) {
        Object[] obj = { vo.getAuthorize_resource_id(),vo.getParty_id(),vo.getAuthorize_status(),vo.getIs_affix_data(),vo.getIs_recursive(),vo.getAccess_type(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmAuthorizeResourceRecordVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmAuthorizeResourceRecordVo vo = (RmAuthorizeResourceRecordVo)obj;
				return new Object[]{ vo.getAuthorize_resource_id(),vo.getParty_id(),vo.getAuthorize_status(),vo.getIs_affix_data(),vo.getIs_recursive(),vo.getAccess_type(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
