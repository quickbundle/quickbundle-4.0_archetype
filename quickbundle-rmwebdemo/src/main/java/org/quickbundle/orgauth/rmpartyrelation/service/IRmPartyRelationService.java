//代码生成时,文件路径: E:/QbRmWebDemo/src/main/java/orgauth/rmpartyrelation/service/IRmPartyRelationService.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmpartyrelation.service --> IRmPartyRelationService.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmpartyrelation.service;
...
public interface IRmPartyRelationService {
