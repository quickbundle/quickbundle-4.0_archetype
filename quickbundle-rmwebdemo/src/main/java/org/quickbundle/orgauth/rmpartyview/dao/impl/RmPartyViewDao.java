//代码生成时,文件路径: E:/QbRmWebDemo/src/main/java/orgauth/rmpartyview/dao/impl/RmPartyViewDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmpartyview.dao.impl --> RmPartyViewDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmpartyview.dao.impl;
...
public class RmPartyViewDao extends RmJdbcTemplate implements IRmPartyViewDao, IRmPartyViewConstants {
     ...
     */
	public String[] insert(final RmPartyViewVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmPartyViewVo vo = (RmPartyViewVo)obj;
				return new Object[]{ vo.getId(), vo.getBs_keyword(),vo.getName(),vo.getView_desc(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmPartyViewVo find(String id) {
        return (RmPartyViewVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
            public Object mapRow(ResultSet rs, int i) throws SQLException {
                RmPartyViewVo vo = new RmPartyViewVo();
    ...
    public int update(RmPartyViewVo vo) {
        Object[] obj = { vo.getBs_keyword(),vo.getName(),vo.getView_desc(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmPartyViewVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmPartyViewVo vo = (RmPartyViewVo)obj;
				return new Object[]{ vo.getBs_keyword(),vo.getName(),vo.getView_desc(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
