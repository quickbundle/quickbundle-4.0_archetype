//代码生成时,文件路径: E:/QbRmWebDemo/src/main/java/orgauth/rmpartytyperelationrule/web/RmPartyTypeRelationRuleConditionAction.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmpartytyperelationrule.web --> RmPartyTypeRelationRuleConditionAction.java
 * 
 * 功能描述:
 * 
...
public class RmPartyTypeRelationRuleConditionAction extends RmPartyTypeRelationRuleAction implements IRmPartyTypeRelationRuleConstants {
    ...
    public ActionForward queryAll(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(condition == null) {
            throw new RmPartyTypeRelationRuleException(MESSAGE_NO_CONDITION_KEY);
        }
