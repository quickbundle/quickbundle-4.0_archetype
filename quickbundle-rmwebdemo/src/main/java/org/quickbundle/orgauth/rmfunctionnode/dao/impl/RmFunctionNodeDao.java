//代码生成时,文件路径: e:/download/QbRmWebDemo/src/main/java/orgauth/rmfunctionnode/dao/impl/RmFunctionNodeDao.java
 ...
 * 
 * 文件名称: org.quickbundle.orgauth.rmfunctionnode.dao.impl --> RmFunctionNodeDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.orgauth.rmfunctionnode.dao.impl;
...
public class RmFunctionNodeDao extends RmJdbcTemplate implements IRmFunctionNodeDao, IRmFunctionNodeConstants {
    ...
    public String insert(RmFunctionNodeVo vo) {
        ...
        vo.setId(id);
        Object[] obj = { vo.getId(), vo.getNode_type(),vo.getFunction_property(),vo.getName(),vo.getEnable_status(),vo.getTotal_code(),vo.getOrder_code(),vo.getFuncnode_authorize_type(),vo.getDescription(),vo.getData_value(),vo.getPattern_value(),vo.getIs_leaf(),vo.getIcon(),vo.getHelp_name(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
     ...
     */
	public String[] insert(final RmFunctionNodeVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				...
				return new Object[]{ vo.getId(), vo.getNode_type(),vo.getFunction_property(),vo.getName(),vo.getEnable_status(),vo.getTotal_code(),vo.getOrder_code(),vo.getFuncnode_authorize_type(),vo.getDescription(),vo.getData_value(),vo.getPattern_value(),vo.getIs_leaf(),vo.getIcon(),vo.getHelp_name(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmFunctionNodeVo find(String id) {
        return (RmFunctionNodeVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmFunctionNodeVo vo) {
        Object[] obj = { vo.getNode_type(),vo.getFunction_property(),vo.getName(),vo.getEnable_status(),vo.getTotal_code(),vo.getOrder_code(),vo.getFuncnode_authorize_type(),vo.getDescription(),vo.getData_value(),vo.getPattern_value(),vo.getIs_leaf(),vo.getIcon(),vo.getHelp_name(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmFunctionNodeVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmFunctionNodeVo vo = (RmFunctionNodeVo)obj;
				return new Object[]{ vo.getNode_type(),vo.getFunction_property(),vo.getName(),vo.getEnable_status(),vo.getTotal_code(),vo.getOrder_code(),vo.getFuncnode_authorize_type(),vo.getDescription(),vo.getData_value(),vo.getPattern_value(),vo.getIs_leaf(),vo.getIcon(),vo.getHelp_name(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
