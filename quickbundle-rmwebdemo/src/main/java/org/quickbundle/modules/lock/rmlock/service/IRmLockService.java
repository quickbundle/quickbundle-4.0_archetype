//代码生成时,文件路径: D:/rc/svn/fm/code/cu-tm/src/main/java/modules/lock/rmlock/service/IRmLockService.java
 ...
 * 
 * 文件名称: org.quickbundle.modules.lock.rmlock.service --> IRmLockService.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.modules.lock.rmlock.service;
...
public interface IRmLockService {
