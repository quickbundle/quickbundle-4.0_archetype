//代码生成时,文件路径: D:/rc/svn/fm/code/cu-tm/src/main/java/modules/lock/rmlock/dao/impl/RmLockDao.java
 ...
 * 
 * 文件名称: org.quickbundle.modules.lock.rmlock.dao.impl --> RmLockDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.modules.lock.rmlock.dao.impl;
...
public class RmLockDao extends RmJdbcTemplate implements IRmLockDao, IRmLockConstants {
     ...
     */
	public String[] insert(final RmLockVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmLockVo vo = (RmLockVo)obj;
				return new Object[]{ vo.getId(), vo.getUser_id(),vo.getBs_keyword(),vo.getLock_content(),vo.getLock_date(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmLockVo find(String id) {
        return (RmLockVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmLockVo vo) {
        Object[] obj = { vo.getUser_id(),vo.getBs_keyword(),vo.getLock_content(),vo.getLock_date(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmLockVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmLockVo vo = (RmLockVo)obj;
				return new Object[]{ vo.getUser_id(),vo.getBs_keyword(),vo.getLock_content(),vo.getLock_date(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
