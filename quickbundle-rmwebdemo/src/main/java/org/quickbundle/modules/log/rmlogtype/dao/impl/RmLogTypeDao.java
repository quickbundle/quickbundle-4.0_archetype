//代码生成时,文件路径: E:/QbRmWebDemo/src/main/java/modules/log/rmlogtype/dao/impl/RmLogTypeDao.java
 ...
 * 
 * 文件名称: org.quickbundle.modules.log.rmlogtype.dao.impl --> RmLogTypeDao.java
 * 
 * 功能描述:
 * 
...
package org.quickbundle.modules.log.rmlogtype.dao.impl;
...
public class RmLogTypeDao extends RmJdbcTemplate implements IRmLogTypeDao, IRmLogTypeConstants {
     ...
     */
	public String[] insert(final RmLogTypeVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmLogTypeVo vo = (RmLogTypeVo)obj;
				return new Object[]{ vo.getId(), vo.getBs_keyword(),vo.getName(),vo.getIs_record(),vo.getIs_alone_table(),vo.getTable_name(),vo.getPattern_value(),vo.getMatch_priority(),vo.getMax_log_sum(),vo.getDescription(),vo.getCustom_xml(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
     ...
     * @return 查询到的VO对象
     */
    public RmLogTypeVo find(String id) {
        return (RmLogTypeVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
     ...
     * @return 成功更新的记录数
     */
    public int update(RmLogTypeVo vo) {
        Object[] obj = { vo.getBs_keyword(),vo.getName(),vo.getIs_record(),vo.getIs_alone_table(),vo.getTable_name(),vo.getPattern_value(),vo.getMatch_priority(),vo.getMax_log_sum(),vo.getDescription(),vo.getCustom_xml(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
     ...
     * @return 成功更新的记录数组
     */
	public int[] update(final RmLogTypeVo[] vos) {
		return batchUpdate(SQL_UPDATE_BY_ID, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmLogTypeVo vo = (RmLogTypeVo)obj;
				return new Object[]{ vo.getBs_keyword(),vo.getName(),vo.getIs_record(),vo.getIs_alone_table(),vo.getTable_name(),vo.getPattern_value(),vo.getMatch_priority(),vo.getMax_log_sum(),vo.getDescription(),vo.getCustom_xml(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
			}
		});
	}
     ...
     * @return 查询到的VO列表
     */
    public List<RmLogTypeVo> queryByCondition(String queryCondition, String orderStr, int startIndex, int size, boolean selectAllClumn) {
		String strsql = null;
        if(selectAllClumn) {
