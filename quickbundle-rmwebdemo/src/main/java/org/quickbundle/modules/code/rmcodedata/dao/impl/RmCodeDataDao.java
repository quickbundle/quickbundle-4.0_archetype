//代码生成时,文件路径: E:/platform/myProject/qbrm/code/QbRmWebDemo/src.open/org/quickbundle/modules/code/rmcodedata/dao/impl/RmCodeDataDao.java
//代码生成时,系统时间: 2010-04-08 21:15:47.0
//代码生成时,操作系统用户: Administrator

/*
 * 系统名称:单表模板 --> QbRmWebDemo
 * 
 * 文件名称: org.quickbundle.modules.code.rmcodedata.dao.impl --> RmCodeDataDao.java
 * 
 * 功能描述:
 * 
 * 版本历史: 2010-04-08 21:15:47.0 创建1.0.0版 (白小勇)
 *  
 */

package org.quickbundle.modules.code.rmcodedata.dao.impl;
...
public class RmCodeDataDao extends RmJdbcTemplate implements IRmCodeDataDao, IRmCodeDataConstants {
    ...
    /**
     * 批量更新插入多条记录，用id作主键，把null全替换为""
     * 
     * @param vos 添加的VO对象数组
     * @return 若添加成功，返回新生成的id数组
     */
	public String[] insert(final RmCodeDataVo[] vos) {
		...
		batchUpdate(SQL_INSERT, vos, new RmJdbcTemplate.CircleVoArray() {
			public Object[] getArgs(Object obj) {
				RmCodeDataVo vo = (RmCodeDataVo)obj;
				return new Object[]{ vo.getId(), vo.getCode_type_id(),vo.getData_key(),vo.getEnable_status(),vo.getData_value(),vo.getTotal_code(),vo.getRemark(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id() };
			}
		});
		return ids;
	}
    ...
    public RmCodeDataVo find(String id) {
        return (RmCodeDataVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
    ...
    public int update(RmCodeDataVo vo) {
        Object[] obj = { vo.getCode_type_id(),vo.getData_key(),vo.getEnable_status(),vo.getData_value(),vo.getTotal_code(),vo.getRemark(),vo.getUsable_status(),vo.getModify_date(),vo.getModify_ip(),vo.getModify_user_id(), vo.getId() };
