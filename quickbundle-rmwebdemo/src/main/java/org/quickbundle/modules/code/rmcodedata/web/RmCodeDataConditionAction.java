//代码生成时,文件路径: E:/platform/myProject/qbrm/code/QbRmWebDemo/src.open/org/quickbundle/modules/code/rmcodedata/web/RmCodeDataConditionAction.java
//代码生成时,系统时间: 2010-04-08 21:15:46.875
 ...
 * 功能描述:
 * 
 * 版本历史: 2010-04-08 21:15:46.875 创建1.0.0版 (白小勇)
 *  
 */
...
import org.quickbundle.modules.code.rmcodedata.util.RmCodeDataException;
...
public class RmCodeDataConditionAction extends RmCodeDataAction implements IRmCodeDataConstants {
    ...
    public ActionForward queryAll(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if(condition == null) {
            throw new RmCodeDataException(MESSAGE_NO_CONDITION_KEY);
        }
