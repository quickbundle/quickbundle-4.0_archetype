<%@ page errorPage="/jsp/common/error/err.jsp" %><%@ taglib uri="/WEB-INF/tld/c.tld" prefix="c"%><%@ taglib uri="/WEB-INF/tld/struts-bean.tld" prefix="bean" %><%@ taglib uri="/WEB-INF/tld/struts-layout.tld" prefix="layout" %><%@page import="org.quickbundle.project.init.RmConfig"%><%@page import="org.quickbundle.tools.support.log.RmLogHelper"%><%@page import="org.quickbundle.tools.helper.RmStringHelper"%><%@page import="org.quickbundle.tools.helper.RmJspHelper"%><%@page import="org.quickbundle.project.IGlobalConstants"%>
