...
<%
	...
	String filename_pie = chart.generatePieChart("按type_keyword统计", session, new PrintWriter(out));
	String graphURL_pie = request.getContextPath() + "/rm/DisplayChart?filename=" + filename_pie;
	
	String filename_bar = chart.generateBarChart("按type_keyword统计", session, new PrintWriter(out));
