...
<%
	...
	try {
		if(isSubmit) {
		    ...
		    rtVo = RmExcelHandler.getListDataFromSheet(f, RmMessageVo.class.getName(), new RmExcelHandler.IValidateData() {
		        public String isValid(Object obj) {
		            String errorMsg = "";
		            RmMessageVo vo = (RmMessageVo)obj;
		    ...
		    if(rtVo.getErrorMsg() == null) {
		        RmMessageVo[] diseaseVos = (RmMessageVo[])rtVo.getLData().toArray(new RmMessageVo[0]);
...
<table class="table_div_content">
	...
	<tr>
		...
		<td>
			<a href="#"><u>批量导入<%=IRmMessageConstants.TABLE_NAME_DISPLAY %>模板</u></a>
		</td>
		<td align="right">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td>
			<input type="text" class="text_field_reference_readonly" name="upload_oldName" validate="notNull;" inputName="Excel文件和图片(Zip格式)" value="" maxLength="200" hiddenInputId="upload_saveName,upload_isImage,upload_abbreviatoryName,upload_saveNameWidthHeight,upload_abbreviatoryNameWidthHeight,upload_remark"/><img class="refButtonClass" src="<%=request.getContextPath()%>/images/09.gif" onclick="javascript:getUploadWindow(new Array(upload_saveName, upload_oldName, upload_isImage, upload_abbreviatoryName, upload_saveNameWidthHeight, upload_abbreviatoryNameWidthHeight, upload_remark),'<%=request.getContextPath()%>/', 800, 600, '1-1');"/>
