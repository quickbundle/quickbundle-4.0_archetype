...
<script type="text/javascript">
	...
	function toAdd_onClick() {  //到增加记录页面
		window.location="<%=request.getContextPath()%>/orgauth/rmuseronlinerecord" + rmJspPath + "/insertRmUserOnlineRecord.jsp";
	}
...
<div id="div_funcNode" style="padding:20px 10px 10px 0px; display:none" align="right">
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/RmUserOnlineRecordConditionAction.do?cmd=queryAll&<%=IRmUserOnlineRecordConstants.DEFAULT_CONDITION_KEY_ARRAY[0]%>=1">带条件模式</a>
	<a class="aul" target="_blank" href="<%=request.getContextPath()%>/RmUserOnlineRecordConditionAction.do?cmd=queryAll&<%=IRmUserOnlineRecordConstants.DEFAULT_CONDITION_KEY_ARRAY[0]%>=1&<%=IRmUserOnlineRecordConstants.REQUEST_IS_READ_ONLY%>=1">带条件只读</a>
	</div>
<!-- end -->
