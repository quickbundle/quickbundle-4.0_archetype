...
MainPanel = function(){
    ...
    MainPanel.superclass.constructor.call(this, {
        ...
        items: {
            ...
            html: '<iframe src="<%=request.getContextPath()%>/jsp/welcome.jsp" width="100%" height="100%" frameborder="0"></iframe>',
            iconCls:'icon-docs',
            autoScroll: true
        }
    });
    ...
    loadClass : function(href, cls, member){
        ...
        if(tab){
            ...
            var p = this.add(new DocPanel({
                id: id,
                cclass : cls,
                html:'<iframe src="' + href + '" width="100%" height="100%" frameborder="0"></iframe>',
